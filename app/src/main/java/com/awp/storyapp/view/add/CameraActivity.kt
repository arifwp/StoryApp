...
import com.awp.storyapp.databinding.ActivityCameraBinding
import com.awp.storyapp.view.utils.createFile
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun setBindButton() {
        binding.captureImage.setOnClickListener { shoot() }
